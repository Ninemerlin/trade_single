...
-- Records of order
-- ----------------------------
INSERT INTO `order` (`id`, `total_price`, `payment_type`, `seller_id`, `buyer_id`, `shop_id`, `address`, `status`, `create_time`, `pay_time`, `consign_time`, `end_time`) VALUES
    (1, 56400, 1, 3,1, 1, '北京朝阳区修正大厦 李佳红 13700221122', 6, '2021-07-28 11:01:41', NULL, NULL, '2021-07-28 11:01:47');
